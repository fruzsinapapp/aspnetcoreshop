...
namespace A1CRCS_SOF_202231_.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                    ...
                    var access_token_json = new WebClient().DownloadString("https://graph.facebook.com/oauth/access_token?client_id=0&client_secret=0&grant_type=client_credentials");
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.PictureData = webc.DownloadData(Input.PictureUrl);
                user.PictureContentType = webc.ResponseHeaders["Content-Type"];
